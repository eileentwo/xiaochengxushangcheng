...
Page({
  ...
  getLocal: function (){
    ...
    wx: wx.getLocation({
      ...
      success: function (res) {
        console.log(res, 47)
        if (util.praseStrEmpty(res.longitude) !=''){
  ...
  onShow:function(){
    ...
    if (app.globalData.citystatus ==1){
      ...
      if (!localCur.hasOwnProperty('longitude') && util.praseStrEmpty(localCur.longitude) != 'undefined' || util.praseStrEmpty(cityInfos.city) != '') {
        this.getLocal();
      } else {
